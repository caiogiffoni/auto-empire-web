    ...
    <div>
      ...
      >
        ...
        <DivContent>
            ...
            <Typography className='title1' gutterBottom>Publicado</Typography>
            <DivButtonCenter>
                <BootstrapButton id='secondary' onClick={handleClose} variant="contained" disableRipple>
                    Sim
                </BootstrapButton>
        ...
        <DivButton>
            <BootstrapButton id='secondary' className='btn' onClick={handleClose} variant="contained" disableRipple>
                Excluir anúncio
            </BootstrapButton>
